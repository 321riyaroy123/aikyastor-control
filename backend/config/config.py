...
CEPHFS_NAME = os.getenv("CEPHFS_NAME", "cephfs")
CEPHFS_USER = os.getenv("CEPHFS_USER", "admin")
CEPHFS_MONITORS = os.getenv("CEPHFS_MONITORS", "")
CEPHFS_KEYRING = os.getenv("CEPHFS_KEYRING", "/etc/ceph/ceph.client.admin.keyring")
