...
Moved from: logger.py (project root)
Responsibility: unchanged — configure and expose the shared `logger` instance
used throughout the backend (console + rotating file handler).
"""
